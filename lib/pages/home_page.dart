...
//import 'package:kupfuma/pages/deal_room.dart';
...
class MenuItems {
  ...
  static const otherUser =
      MenuItem(text: 'Secondary User', icon: Icons.people_outline);
  static const home =
              ...
              Container(
                ...
                child: Row(
                  children: [
                    Expanded(
                      child: Text(
                        'Wishlist: How much capital do you wish to raise\n to take your business to the next level',
...
class ISPageState extends State<ISPage> {
  ...
  Future<void> generatePdf() async {
          ...
          child: pw.Column(
            children: [
              ...
              pw.Table.fromTextArray(
                // Add the income statement data
                headers: ['$sme:', '$currency'],
                data: [
    ...
    final file = File('income_statement.pdf');
          ...
          actions: <Widget>[
            ElevatedButton(
              ...
              onPressed: () {
                ...
                FirebaseDatabase.instance
                    .ref()
                    .child(actualMonthRef + '/guessestimate/' + uid + "/ebita/")
                    .update(casset);
...
// Stripe.publishableKey='pk_live_51N85NcGg8GWdATteQ5h08RLz2EwsFs4mHlVQKzRHJljhYbDfjYWWlV3JQdgZJot0Cd2qew4FiFLj7u96g9XkBvA000qGx4Lx21';
    ...
    FirebaseDatabase.instance
        .ref()
        .child(actualMonthRef + '/guessestimate/' + uid)
        .onChildAdded
        .listen((event) {
      Map revenue = event.snapshot.value as Map;
      ...
      body: ListView(
        children: [
          ...
          ElevatedButton(
              ...
              onPressed: null,
              child:
                  Text('$sme: Guess Value - ' + calcEbita.toStringAsFixed(2))),
          Row(
            mainAxisAlignment: MainAxisAlignment.end,
            children: <Widget>[
              Expanded(
...
class AssetsPageState extends State<AssetsPage> {
  ...
  void initState() {
    ...
    FirebaseDatabase.instance
      ...
      countExpenses++;
      setState(() {
        totalExpenses += double.parse(revenue['priceController']);
        averageExpenses += (double.parse(revenue['priceController']) -
            double.parse(revenue['accDepController']));
        percentageExpenses = (averageExpenses / totalExpenses) * 100;
      });
    });
    strings.add("Nepal");
    ...
    dbRef = FirebaseDatabase.instance
        .ref()
        .child('balanceSheet' + '/' + uid + '/' + 'fixedAssets/');
    referenceAsset = FirebaseDatabase.instance.ref().child(
        actualMonthRef + '/assetNumber' + '/' + uid + '/' + 'fixedAssets/');
    reference = FirebaseDatabase.instance
        .ref()
        .child('balanceSheet' + '/' + uid + '/' + 'fixedAssets/');
    _controller = TextEditingController(text: '2');
    ...
    return GestureDetector(
          ...
          Navigator.push(
            ...
            MaterialPageRoute(
                builder: (context) => Assets1Route(
                    ...
                    supplierController1: revenue['supplierController'],
                    depMonthsController1: revenue['depMonthsController1'],
                    monthlyDepController1: revenue['purchaseDateController'],
                    monthsInUseController1: revenue['monthsInUseController'],
        ...
        child: SingleChildScrollView(
            ...
            child: Row(children: [
              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Text(
                  revenue['purchaseDateController'],
                  style: TextStyle(
                    color: Colors.grey[500],
                  ),
                ),
                Text(
                  revenue['assetNumberController'],
                  style: TextStyle(
                    fontSize: 22,
                  ),
                ),
                ...
                Expanded(
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        const Text(''),
                        Text("" + countExpenses.toStringAsFixed(0)),
                    ...
                    children: [
                      Column(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            "Asset Number : " + assetNumber.toString(),
                            textAlign: TextAlign.center,
                            style: TextStyle(
                              color: Colors.grey[500],
                              fontWeight: FontWeight.bold,
                          ...
                          TextFormField(
                            ...
                            controller: monthlyDepController,
                            keyboardType: TextInputType.number,
                            decoration: const InputDecoration(
                              border: OutlineInputBorder(),
                              labelText: 'Monthly Depreciation',
                              hintText: 'Enter Monthly Depreciation',
                            ),
                          ),
                          const SizedBox(height: 10),
                          TextFormField(
                            ...
                            controller: monthsInUseController,
                            keyboardType: TextInputType.number,
                            decoration: const InputDecoration(
                              border: OutlineInputBorder(),
                              labelText: 'Months In Use',
                              hintText: 'Months In Use',
                            ),
                          ),
                          const SizedBox(height: 10),
                          TextFormField(
                            ...
                            controller: accDepController,
                            keyboardType: TextInputType.number,
                            decoration: const InputDecoration(
                              border: OutlineInputBorder(),
                              labelText: 'Accumulated Depreciation',
                              hintText: 'Accumulated Depreciation',
                            ),
                          ),
                          const SizedBox(height: 10),
                          TextFormField(
                              ...
                              MaterialButton(
                                ...
                                onPressed: () {
                                  Map<String, String> revenue = {
                                    ...
                                    'monthsInUseController':
                                        monthsInUseController.text,
                                    'accDepController': accDepController.text,
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(children: [
          ...
          SizedBox(height: 5),
          Text(
            "Audit Comment\n" + widget.auditCommentController1,
            style: TextStyle(
              color: Colors.blue,
            ),
          ),
          ...
          ElevatedButton(
            onPressed: () {
              uid = user?.uid ?? 'uid';
              FirebaseDatabase.instance
                  .ref('balanceSheet' + '/' + uid + '/fixedAssets/' + widget.ky)
                  .remove();
                                    ...
                                    child: Column(
                                      children: <Widget>[
                                        TextfieldDatePicker(
                                          ...
                                          cupertinoDatePickerMinimumYear: 2023,
...
// push the form data to Firebase Realtime Database
                          ...
                          child: const Text('Sell My Business')),
                      const SizedBox(
                        height: 5,
                      ),
                      ElevatedButton(
  ...
  DatabaseReference dbRef =
      FirebaseDatabase.instance.reference().child(actualMonthRef + '/Selling');

  Widget listExpenses({required Map revenue}) {
    return Column(
      children: [
        Image.network(
            "https://firebasestorage.googleapis.com/v0/b/kupfuma-62764.appspot.com/o/dealImage.png?alt=media&token=31f22375-5bb9-481a-9ec0-e793ea3a355b"),
        Row(
          mainAxisAlignment: MainAxisAlignment.spaceEvenly,
          children: [
            Column(
            ...
            Column(
              children: [
                ...
                Text(revenue['revenueYear']),
                Text(revenue['grossMargin']),
                Text(revenue['revenueMultiple']),
                Text(revenue['operatingYears']),
              ],
            ),
            Column(
              children: [
            ...
            Column(
              children: [
                Text(revenue['percentageStake']),
                Text(revenue['revenueYear']),
                Text(revenue['profitMargin']),
                Text(revenue['profitMultiple']),
                Text(revenue['industry']),
                              ...
                              child: Column(
                                children: <Widget>[
                                  ...
                                  TextField(
                                    ...
                                    decoration: InputDecoration(
                                      labelText:
                                          'Briefly describe your motivation to buy the business',
                                    ),
                                  ),
                                  TextFormField(
                                    controller: reportController,
                                    decoration: InputDecoration(
                                      labelText: 'Attach proof of funds',
                                    ),
                                  ),
                                ],
                              ),
...
// push the form data to Firebase Realtime Database
                                  FirebaseDatabase.instance
                                      .reference()
                                      .child(actualMonthRef + '/buying/' + uid)
                                      .push()
                                      .set({
                                    'whenDoYouWantToSell': whenController.text,
                                    'howMuchAreYouSellingFor':
                                        valueController.text,
                                    'brieflyDescribeYourMotivationToSellTheBusiness':
                                        descController.text,
                    ...
                    child: const Text('I Am Intrested')),
              ],
            ),
          ],
        ),
                                  ...
                                  children: <Widget>[
                                    TextfieldDatePicker(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        hintText: 'When do you want to sell?',
                                        hintStyle: TextStyle(
                                            fontSize: 12,
                                            fontWeight: FontWeight.bold),
                                        filled: true,
