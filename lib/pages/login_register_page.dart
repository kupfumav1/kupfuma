            ...
            Visibility(
              ...
              child: Column(
                ...
                TextField(
                    ...
                    controller: _controllerWish,
                    decoration: InputDecoration(
                      labelText: 'Wishlist! What is the amount of venture capital you wish to raise to take your business to the next level',
                      hintText: 'Venture Capital you wish to raise',
                      filled: true, //<-- SEE HERE
                      fillColor: Colors.white,
                    ),
                    style: const TextStyle(color: Colors.black),
